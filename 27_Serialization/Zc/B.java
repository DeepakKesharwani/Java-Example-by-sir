...
class B{
	public static void main(String[] args){
		try{
			FileInputStream fis = new FileInputStream("a/a1/a2/a3/kkr.txt");
			ObjectInputStream ois = new ObjectInputStream(fis);
			
			Employee e1 = (Employee)ois.readObject();

			System.out.println("############### Deserialization by folder kkr.txt ################");
			...
			System.out.println("######################Deserialization by Folder rcb.txt ############################");

			FileInputStream fis1 = new FileInputStream("b/b1/b2/b3/rcb.txt");
